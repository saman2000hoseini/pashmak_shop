...
window.addEventListener("load",function(){
    ...
    for (r = 0; r < pageList.length; r++) {
        document.getElementById("products").innerHTML += pageList[r] + "<br/>";
    }
});
...
function loadPage(event){
    ...
    document.getElementById("paginator-items").innerHTML = "";
    for (r = 0; r < pageList.length; r++) {
        document.getElementById("paginator-items").innerHTML += pageList[r] + "<br/>";
    }
}
